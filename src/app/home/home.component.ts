...
import {ITemplateDocument, ITemplateField, ITemplateInput} from '../shared/shared.model';
...
type TNode = ITemplateDocument | ITemplateField;
...
export class HomeComponent implements OnInit, OnDestroy {
  @ViewChild('documenttree') treeRef: MatTree<TNode>;
  changedName = false;
